<script>
  ...
  onMount(() => {
    // mentions = fetch(
    //   `https://webmention.io/api/mentions.jf2?sort-by=published&sort-dir=up&target=https://dan.my.id/catatan/6-komentar-blog-statis-dengan-webmention/`
    // )
    mentions = fetch(
      ...
      .then((wms) => {
        ...
        // console.log({ likes, retweets, replies, tweetId })
...
<style lang="postcss">
  .avatar {
    @apply rounded-full w-12 h-12 ring-offset-2 ring-2  hover:ring-4;
    @apply bg-base-100 ring-offset-base-100 ring-base-200;
    img {
